...
- **2026 shirt listings approved**: Vultures' Last Encore and Serpent Double Kick use the user-approved front-and-back mockups, sell for $30 each, and are available only in M, L, XL, and XXL. Keep their merchandise previews and View Details images large enough to inspect the shirt artwork.
