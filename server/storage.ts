  ...
  private async initializeData() {
    ...
    const members: InsertBandMember[] = [
      {
        ...
        imageUrl: "/attached_assets/12477_1754975744481.jpg"
      },
      {
        name: "STEVE URQUIDES",
        role: "GUITAR",
    ...
    const galleryVideoData: InsertGalleryVideo[] = [
      {
        ...
        title: "Stronger Live",
        description: "",
        thumbnailUrl: "/attached_assets/IMG_20250727_111131_1754975230801.jpg",
    ...
    const merchandiseData: InsertMerchandise[] = [
      ...
      },
      {
        ...
        description: "Black Gildan t-shirt with the white HR chest logo and the full Vultures' Last Encore artwork on the back. Available in M, L, XL, and XXL.",
        price: "$30.00",
        imageUrl: "/attached_assets/headrust-vulture-tshirt-mockup.png",
        category: "apparel",
        inStock: 1
      },
      {
        name: "Serpent Double Kick T-Shirt",
        description: "Black Gildan t-shirt with the white HR chest logo and the full Serpent Double Kick artwork on the back. Available in M, L, XL, and XXL.",
        price: "$30.00",
        imageUrl: "/attached_assets/headrust-serpent-tshirt-mockup.png",
        category: "apparel",
        inStock: 1
      },
      {
      ...
      },
      {
        ...
        description: "Premium black Richardson snapback with a structured six-panel, mid-profile fit, pre-curved visor, adjustable snap closure, and a foam-backed Headrust logo with raised white stitching. One size fits most.",
        price: "$40.00",
