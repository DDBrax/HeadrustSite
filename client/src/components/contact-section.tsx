          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://open.spotify.com/artist/4wPz7884HhUrJtwVCwuAht" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-metal-gold text-2xl transition-colors duration-300">
