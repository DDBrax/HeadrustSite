      ...
      <div className="container-padding">
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
          <p className="text-lg text-gray-300 leading-relaxed">
            Headrust was formed in 2005 by drummer George Samaniego and guitarist Steve Urquides, lifelong friends bonded by their passion for heavy music. After early lineup changes, the band found new life in 2006 with vocalist Dennis Brack, whose powerful voice and energy gave Headrust a fresh edge. With Matt Mier joining in 2026 to hold down the low end, Headrust continues to forge its signature sound—heavy rhythms, dynamic melodies, and raw emotion—building a reputation as a relentless force in heavy music.
          </p>
        </div>
                ...
                <div className="relative w-full aspect-square overflow-hidden bg-gray-900">
                  <img 
                    ...
                    className={`w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500 ${
                      index === 0 ? 'object-[center_35%] scale-110' : index === 1 ? 'object-[center_20%]' : index === 3 ? 'object-[center_28%]' : 'object-top'
                    }`}
                  />
